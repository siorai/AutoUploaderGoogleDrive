...
# containing an a table to be compiled using
# AutoUploaderGoogleDrive.upload.encode_message
...
<p>Direct link to Google Drive folder containing the subdirectory:&nbsp;
  <a href="%s">%s</a>
</p>
</body>
...
def getRemoteFolderInfo(Resource_ID):
    ...
    logging.debug("DRIVEQUERY: METADATA: Recieved info for %s" %
                  FolderInfo['title'])
    return FolderInfo
